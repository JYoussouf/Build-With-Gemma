...
const nextConfig: NextConfig = {
  ...
  output: "standalone",
  // There is no landing page: the app opens on the race dashboard. Declared
  // here rather than as a root page that redirects, so `/` is not a route at
  // all — nothing to render, nothing to keep in step with the tab bar.
  async redirects() {
